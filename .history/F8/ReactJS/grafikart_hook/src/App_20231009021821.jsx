...
function App() {
  ...
  return (
    ...
    <SearcheBar showStockedOnly={showStockedOnly} onStockedOnlyChange={setShowStockedOnly}/>
  ...
  function SearcheBar({showStockedOnly,onStockedOnlyChange}){
    return (
      <div>
        <div className = "mb-3"> 
          <Input value="" onChange={()=> null} placeholder= "Rechercher..." />
          <Checkbox id="stocked" checked ={showStockedOnly} onChange= {()=> null} label ="N' afficher que les produits en stock"/>
