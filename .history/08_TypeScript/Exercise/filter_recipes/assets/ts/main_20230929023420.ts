...
const prepTimeDetail = document.getElementById("details-prepTime") as HTMLParagraphElement
const cookTimeDetail = document.getElementById("details-cookTime") as HTMLParagraphElement
...
const refeshRecipesContainer = () =>{
    ...
    recipesTab.forEach(recipe => {
        ...
        newButton.addEventListener('click', () => {
            ...
            // servingsDetail.innerHTML = `${recipe.servings}`
            // instructionsDetail.innerHTML = `${recipe.cookTime}`
