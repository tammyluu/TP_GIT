...
displayRecipesDetail.addEventListener('submit', (e: any) =>{
    ...
    const nameDetail = document.getElementById("details-name") as HTMLParagraphElement
    const servingsDetail = document.getElementById("details-servings") as HTMLParagraphElement
    ...
    const ingredientsDetail = document.getElementById("details-ingredients") as HTMLParagraphElement
    const instructionsDetail = document.getElementById("details-instructions") as HTMLParagraphElement
