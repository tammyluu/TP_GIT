...
function displayRecipesDetail(recipes: IRecipe[]) {
  ...
  const prepTime = document.getElementById("details-avatarURL") as HTMLImageElement
  const cookTime = document.getElementById("details-dateOfBirth") as HTMLInputElement
  const ingredients = document.getElementById("details-age") as HTMLSpanElement
  const instructions = document.getElementById("details-email") as HTMLInputElement
