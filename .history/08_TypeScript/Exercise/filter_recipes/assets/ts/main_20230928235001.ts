...
for (const key in recipes) {
    if (recipes.prototype.hasOwnProperty.call(re, key)recipes   const element = objectrecipesipes 
    }
}

const recipesConre = document.querySelector("#recipesContainer") as HTMLDivElement
