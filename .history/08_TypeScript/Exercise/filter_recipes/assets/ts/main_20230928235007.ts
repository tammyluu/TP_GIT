...
for (const key in recipes) {
    if (recipes.prototype.hasOwnProperty.call(recipes, key)recipes   const element = objectrecipesipes 
    }
}

const recipesConrecipes = document.querySelector("#recipesContainer") as HTMLDivElement
