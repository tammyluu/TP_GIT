...
displayRecipesDetail.addEventListener('submit', (e: any) =>{
    ...
    const servingsDetail = document.getElementById("details-servings") as HTMLElement
    const prepTimeDetail = document.getElementById("details-prepTime") as HTMLElement
    const cookTimeDetail = document.getElementById("details-cookTime") as HTMLElement
    const ingredientsDetail = document.getElementById("details-ingredients") as HTMLElement
    const instructionsDetail = document.getElementById("details-instructions") as HTMLElement
    const recipesInfo = new recipes (nameDetail.value,servingsDetail.value,prepTimeDetail.value, cookTimeDetail.value, ingredientsDetail.value ) 
})
