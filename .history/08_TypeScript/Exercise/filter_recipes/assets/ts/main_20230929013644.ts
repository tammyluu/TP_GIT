...
displayRecipesDetail.addEventListener('submit', (e: any) =>{
    ...
    const recipesInfo = new recipes (nameDetail.value,servingsDetail.value,prepTimeDetail.value, cookTimeDetail.value, ingredientsDetail.value, instructionsDetail ) 
