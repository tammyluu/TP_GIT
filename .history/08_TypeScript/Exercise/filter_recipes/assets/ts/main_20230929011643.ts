...
displayRecipesDetail.addEventListener('submit', (e: any) =>{
    e.preventDefault()
    const displayRecipesDetailr = document.querySelector('.myModal');
    const nameDetail = document.getElementById("details-name") as HTMLInputElement
    const servingsDetail = document.getElementById("details-servings") as HTMLInputElement
    ...
    const ingredientsDetail = document.getElementById("details-ingredients") as HTMLInputElement
    const instructionsDetail = document.getElementById("details-instructions") as HTMLInputElement
