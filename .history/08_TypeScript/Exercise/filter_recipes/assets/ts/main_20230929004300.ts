...
function displayRecipesDetail(recipes: IRecipe[]) {
  ...
  const nameDetail = document.getElementById("details-firstname") as HTMLInputElement
  const servingsDetail = document.getElementById("details-lastname") as HTMLInputElement
  const prepTimeDetail = document.getElementById("details-avatarURL") as HTMLImageElement
  const cookTimeDetail = document.getElementById("details-dateOfBirth") as HTMLInputElement
  const ingredientsDetail = document.getElementById("details-age") as HTMLSpanElement
  const instructionsDetail = document.getElementById("details-email") as HTMLInputElement
