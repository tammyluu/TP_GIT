...
const displayRecipesDetail = document.getElementById("displayRecipesDetail") as HTMLFormElement 
...
const refeshRecipesContainer = () =>{
    ...
    recipesTab.forEach(recipe => { 
        ...
        displayRecipesDetail.addEventListener('submit', (e) =>{
            e.preventDefault()
            ...
            selectedRecipe = recipe
            console.log(selectedRecipe); selectedRecipe = recipe
            console.log("1" , selectedRecipe);
            ...
            refeshRecipesContainer()    selectedRecipe = recipe
            console.log("1" , selectedRecipe);
