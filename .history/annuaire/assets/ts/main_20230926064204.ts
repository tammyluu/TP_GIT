...
let myTiltleHTML2 = <HTMLElement>document.querySelector("#details-firstname"); //angle-bracket
let myTitle = document.querySelector("#details-firstname") as HTMLHeadingElement;
