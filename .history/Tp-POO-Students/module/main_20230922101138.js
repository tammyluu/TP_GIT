...
function initalStudentList() {
    ...
    // Ajout des student à la collection Contacts
    for (let student of fakeStudent) {
        let tmp = new Student(student.lastName, student.firstName, new Date(contact.dateNaissance).toLocaleDateString(), contact.telephone, contact.email);
        Contacts.push(tmp);
    }
}
