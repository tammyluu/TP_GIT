...
const ItemDetails = () => {
    ...
    return (
        <>
            ...
            <div className="row">
                <div className="col-6">
                    <img className="img-fluid" src={prodcut.url} alt="image" />
                </div>
                <div className="col-6">
                    <p><b>Nom article : </b>{prodcut.title}</p>
                    <p><b>Détail article : </b>{prodcut.details}</p>
                    <p><b>Prix article : </b>{prodcut.price}€</p>
                </div>
            </div>
