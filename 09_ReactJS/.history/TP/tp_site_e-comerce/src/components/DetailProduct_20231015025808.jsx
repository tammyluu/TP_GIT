...
const ItemDetails = () => {
    ...
    const { itemList, setItemList, cart, setCart } = useContext(ProductContext)
    const { id } = useParams()
    ...
    return (
        <>
            ...
            <button className="mt-3 mb-3 btn btn-outline-success " onClick={addCart}>Ajouter au panier</button>
        </>
    )
}
