...
const DetailProduct = () => {
    ...
    return (
        <>
            ...
            <div className="row">
                <div className="col-6">
                    <img className="img-fluid" src={products.image} alt="image" />
                </div>
                <div className="col-6">
                    <p><b>Nom article : </b>{products.title}</p>
                    <p><b>Détail article : </b>{products.description}</p>
                    <p><b>Prix article : </b>{products.price}€</p>
                </div>
            </div>
