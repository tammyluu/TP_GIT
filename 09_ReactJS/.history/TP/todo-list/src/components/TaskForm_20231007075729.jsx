...
const TaskForm =() =>{
    ...
    return (
       ...
       <form  onSubmit={submitHandle}>
            <div>
                <input type="text" className="form-control" ref={nameTaskRef} required placeholder="Task's name" onInput={addHandle} />
            </div>
            <div>
                <input type="date"  className="form-control" ref={deadlineRef} required placeholder="Deadline"  onInput={addHandle} />
            </div>
            <div>
                < select id="task" className="form-control" ref={isFinishedRef} required onInput={addHandle}>
